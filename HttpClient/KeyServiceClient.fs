...
module KeyServiceClient = 
    ...
    let CreateDeviceGroupKey token deviceGroupId = async { let! response = PostCreateDeviceGroupKey token deviceGroupId |> Http.ContentOrFail
    ...
    let CreateSensorKey token deviceGroupId = async { let! response = PostCreateSensorKey token deviceGroupId |> Http.ContentOrFail
